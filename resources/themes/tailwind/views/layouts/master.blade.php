...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('themes/tailwind/assets/css/app.css') }}" />
    ...
    <script type="text/javascript" src="{{ asset('themes/velocity/assets/js/jquery.min.js') }}"></script>

    {{-- <script type="text/javascript" baseUrl="{{ url()->to('/') }}"
    ...
    <div id="app" class="bg-gray-100">
        ...
        <div class="main-container-wrapper">
            ...
            <div class="main-content-wrapper col-12 no-padding">
                ...
                <content-header url="{{ url()->to('/') }}" :header-content="{{ json_encode($velocityContent) }}"
                    heading="{{ __('velocity::app.menu-navbar.text-category') }}"></content-header>
